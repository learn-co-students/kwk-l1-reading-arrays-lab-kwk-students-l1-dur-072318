...
def last_student_by_method
  STUDENT_NAMES.last# Write a solution that returns the first student using the built in .last method
end
last_student_by_method
def first_second_and_third_students
  puts STUDENT_NAMES[1,2,3]# Write a solution that returns the first, second and third students
end
